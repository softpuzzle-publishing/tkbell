...
function chkRealName_for_IPin (frmName,type){
	...
	if(type == "ipin"){		// 아이핀인증
		var url = '/user/member/ipin/ipin_request_seed.do?parentWindow=' + frmName;                 
	} else {					// 휴대폰인증
		var url = '/user/member/ipin/pcc_V3_request_seed.do?parentWindow=' + frmName;
	}
...
*/
	...
	//member_history에 현재 학년과 학기 정보를 입력
...
//	urlPath = 'http://'+ AuthUrl +'/TrustWeb/AuthStep01_j.asp?m='+chk+'&mode='+m_mode
	urlPath = 'https://'+ AuthUrl +'/TrustWeb/AuthStep01_j.asp?m='+chk+'&mode='+m_mode
